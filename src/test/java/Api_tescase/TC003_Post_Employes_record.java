...
public class TC003_Post_Employes_record extends Test_base {
	...
	public void GetallEmployess() throws InterruptedException {
		...
		logger.info("******* TC003_Post_Employes_record ********");
		...
		respones=http.request(Method.POST,"/create");
	...
	public void tear_down() {
		logger.info("******** TC003_Post_Employes_record close ********");
	}
